...
namespace Quantum
{
	public unsafe partial struct UtilityReasoner : IConsiderationProvider
	{
		...
		{
			Consideration chosenConsideration = SelectBestConsideration(frame, this, 1, reasoner, entity);
		...
		public Consideration SelectBestConsideration<T>(FrameThreadSafe frame, T considerationProvider,
			byte depth, UtilityReasoner* reasoner, EntityRef entity = default) where T : IConsiderationProvider
		{
