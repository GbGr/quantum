	...
	public static unsafe partial class BTManager
	{
		...
		public class ThreadSafe
		{
			...
			public static void Update(FrameThreadSafe frame, EntityRef entity, AIBlackboardComponent* blackboard = null, int compoundId = -1)
			{
				...
				InternalUpdate(frame, entity, ref userParams, blackboard, compoundId);
			}
			...
			private static void InternalUpdate(FrameThreadSafe frame, EntityRef entity, ref BTParamsUser userParams, AIBlackboardComponent* blackboard = null, int compoundId = -1)
			{
