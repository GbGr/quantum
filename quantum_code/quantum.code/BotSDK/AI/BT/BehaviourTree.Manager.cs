...
namespace Quantum
{
	public static unsafe partial class BTManager
	{
		...
		public static Action<EntityRef, string, bool> OnSetupDebugger;

		public static Action<EntityRef, long, bool> OnNodeEnter;
		public static Action<EntityRef, long, bool> OnNodeExit;
		public static Action<EntityRef, long, bool> OnNodeSuccess;
		public static Action<EntityRef, long, bool> OnNodeFailure;
		public static Action<EntityRef, long, bool, bool> OnDecoratorChecked;
		public static Action<EntityRef, long, bool> OnDecoratorReset;
		public static Action<EntityRef, bool> OnTreeCompleted;
		...
		{
			ThreadSafe.Update((FrameThreadSafe)frame, entity, blackboard, compoundId);
		}
		...
		{
			ThreadSafe.Update((FrameThreadSafe)frame, entity, ref userParams, blackboard, compoundId);
		}
	}
}
